...
Parse::Eyapp::eyapplanguageref - Introduction to the Eyapp language 
...
files C<examples/eyapplanguageref/CalcUsingTail.eyp>, C<examples/eyapplanguageref/usecalcusingtail.pl>,
and C<examples/Tail.pm>.
